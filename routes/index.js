...
router.get('/example', client.example);// /example页面 请求获取文章列表 接口会首先检查是否有access_token,如果未获取授权码，则先跳转到授权页面/example/auth
router.get('/example/auth', client.requestAuth); // client调用getRedirectUrl函数跳转到授权页面/OAuth2/authorize,query参数client_id，redirect_url
